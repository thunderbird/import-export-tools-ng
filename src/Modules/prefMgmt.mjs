...
let defaultPrefs = {
  ...
  temp: {
    export_all_warning1: true,
    export_all_warning2: true,
    export_format_warning: true,
    export_import_warning: true,
    export_remote_warning: true,
    hot_keys: "",
...
const legacyPrefToStorageMap = {
  ...
  "export.remote_warning": "temp.export_remote_warning",
...
async function _migrateLegacyPrefs() {
  ...
  let nameFormatLS = await prefCmds.getPref("export.names.defaults.msgNameFormatType");
  console.log("nf ls", nameFormatLS)
  ...
  nameFormatLS = await prefCmds.getPref("export.names.defaults.msgNameFormatType");
  console.log("final nf ls", nameFormatLS)
